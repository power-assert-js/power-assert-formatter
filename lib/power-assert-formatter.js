        ...
        this.context.args.forEach(function (arg) {
            ...
            estraverse.traverse(extractExpressionFrom(jsAST), {
                enter: function (currentNode, parentNode) {
                    ...
                    if (parentNode && currentNode.type === syntax.Literal && parentNode.type === syntax.BinaryExpression && typeof map[parentEspath] === 'object') {
                    ...
                    if (currentNode.type === syntax.BinaryExpression) {
                        obj = {};
                        map[espath] = obj;
                        pairs.push(obj);
                    }
                    if (parentNode && parentNode.type === syntax.BinaryExpression) {
