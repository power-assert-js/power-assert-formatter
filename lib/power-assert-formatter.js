...
(function (root, factory) {
    ...
    PowerAssertContextRenderer.prototype.renderLines = function () {
        ...
        pairs.filter(function (pair) {
            ...
            var patch;
            if (that.shouldUseLineLevelDiff(pair.right.value)) {
    ...
    function EsNode (path, currentNode, parentNode, espathToValue, jsAST) {
        if (path) {
    ...
    EsNode.prototype.name = function () {
    ...
    function onEachEsNode(arg, jsCode, callback) {
        ...
        estraverse.traverse(extractExpressionFrom(jsAST), {
            enter: function (currentNode, parentNode) {
                var esNode = new EsNode(this.path(), currentNode, parentNode, espathToValue, jsAST);
